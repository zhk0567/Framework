...
/**
 * @generated from message framework.greet.v1.SayHelloRequest
 */
export class SayHelloRequest extends Message<SayHelloRequest> {
  ...
  static readonly typeName = "framework.greet.v1.SayHelloRequest";
...
/**
 * @generated from message framework.greet.v1.SayHelloResponse
 */
export class SayHelloResponse extends Message<SayHelloResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "framework.greet.v1.SayHelloResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
