...
export { type AttributeBindingInstruction, type HydrateAttributeInstruction, type HydrateElementInstruction, type HydrateLetElementInstruction, type HydrateTemplateController, IInstruction, type Instruction, type InterpolationInstruction, type IteratorBindingInstruction, type LetBindingInstruction, type ListenerBindingInstruction, type MultiAttrInstruction, type PropertyBindingInstruction, type RefBindingInstruction, type SetAttributeInstruction, type SetClassAttributeInstruction, type SetPropertyInstruction, type SetStyleAttributeInstruction, type SpreadTransferedBindingInstruction, type SpreadElementPropBindingInstruction, type SpreadValueBindingInstruction, type StylePropertyBindingInstruction, type TextBindingInstruction, isInstruction, itHydrateElement, itHydrateAttribute, itHydrateTemplateController, itHydrateLetElement, itSetProperty, itInterpolation, itPropertyBinding, itLetBinding, itRefBinding, itIteratorBinding, itMultiAttr, itTextBinding, itListenerBinding, itAttributeBinding, itStylePropertyBinding, itSetAttribute, itSetClassAttribute, itSetStyleAttribute, itSpreadTransferedBinding, itSpreadElementProp, itSpreadValueBinding, } from './instructions';
