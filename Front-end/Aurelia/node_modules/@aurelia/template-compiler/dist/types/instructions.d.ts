 ...
 */
export declare const itHydrateElement = 0;
export declare const itHydrateAttribute = 1;
export declare const itHydrateTemplateController = 2;
export declare const itHydrateLetElement = 3;
export declare const itSetProperty = 10;
export declare const itInterpolation = 11;
export declare const itPropertyBinding = 12;
export declare const itLetBinding = 13;
export declare const itRefBinding = 14;
export declare const itIteratorBinding = 15;
export declare const itMultiAttr = 16;
export declare const itTextBinding = 30;
export declare const itListenerBinding = 31;
export declare const itAttributeBinding = 32;
export declare const itStylePropertyBinding = 33;
export declare const itSetAttribute = 34;
export declare const itSetClassAttribute = 35;
export declare const itSetStyleAttribute = 36;
export declare const itSpreadTransferedBinding = 50;
export declare const itSpreadElementProp = 51;
export declare const itSpreadValueBinding = 52;
/**
...
export interface HydrateElementInstruction<T extends Record<PropertyKey, unknown> = Record<PropertyKey, unknown>, TDef extends IElementComponentDefinition = IElementComponentDefinition> extends IInstruction {
