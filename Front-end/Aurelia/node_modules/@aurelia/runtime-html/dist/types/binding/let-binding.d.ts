...
export declare class LetBinding implements IBinding, ISubscriber, ICollectionSubscriber {
    ...
    strict: boolean;
    constructor(controller: IBindingController, locator: IServiceLocator, observerLocator: IObserverLocator, ast: IsExpression, targetProperty: string, toBindingContext: boolean, strict: boolean);
    updateTarget(): void;
    handleChange(): void;
