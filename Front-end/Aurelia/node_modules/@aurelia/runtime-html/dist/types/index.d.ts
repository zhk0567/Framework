...
export { Aurelia, IAurelia, type IEnhancementConfig, type IHydrateConfig, 
/**
 * @deprecated
 * Use `ISinglePageAppConfig` instead
 */
type ISinglePageAppConfig as ISinglePageApp, type ISinglePageAppConfig, } from './aurelia';
export { type ISSRManifest, type ISSRScope, type ISSRScopeChild, type ISSRTemplateController, isSSRTemplateController, isSSRScope, ISSRContext, type AdoptedViewResult, type AdoptedViewsResult, adoptSSRView, adoptSSRViews, type ISSRDefinition, type IHydratedDefinition, hydrateSSRDefinition, } from './templating/ssr';
...
export { IEventTarget, IRenderLocation, type INodeSequence, FragmentNodeSequence, IHistory, IWindow, ILocation, getEffectiveParentNode, setEffectiveParentNode, convertToRenderLocation, isRenderLocation, registerHostNode, findMatchingEndMarker, partitionSiblingNodes, } from './dom';
