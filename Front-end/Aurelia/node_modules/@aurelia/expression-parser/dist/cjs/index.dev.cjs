...
const ArrayLiteral = {
    $empty: { $kind: ekArrayLiteral, elements: kernel.emptyArray }
};
function createArrayLiteralExpression(elements) {
    return { $kind: ekArrayLiteral, elements };
}
const ObjectLiteral = {
    $empty: { $kind: ekObjectLiteral, keys: kernel.emptyArray, values: kernel.emptyArray }
};
function createObjectLiteralExpression(keys, values) {
    return { $kind: ekObjectLiteral, keys, values };
}
const Template = {
    $empty: { $kind: ekTemplate, cooked: [''], expressions: kernel.emptyArray }
};
function createTemplateExpression(cooked, expressions = kernel.emptyArray) {
    return { $kind: ekTemplate, cooked, expressions };
}
function createTaggedTemplateExpression(cooked, raw, func, expressions = kernel.emptyArray) {
    cooked.raw = raw;
...
function createInterpolation(parts, expressions = kernel.emptyArray) {
    return {
...
function parse(minPrecedence, expressionType) {
    ...
    while (consumeOpt(6291482 /* Token.Bar */)) {
        ...
        result = createValueConverterExpression(result, name, args);
    }
    /**
    ...
    while (consumeOpt(6291481 /* Token.Ampersand */)) {
        ...
        result = createBindingBehaviorExpression(result, name, args);
    }
    if ($currentToken !== 6291456 /* Token.EOF */) {
...
function parseKeyedExpression(result, optional) {
    const _optional = $optional;
    nextToken();
    result = createAccessKeyedExpression(result, parse(62 /* Precedence.Assign */, etNone), optional);
    consume(7340053 /* Token.CloseBracket */);
...
exports.createAccessBoundaryExpression = createAccessBoundaryExpression;
exports.createAccessGlobalExpression = createAccessGlobalExpression;
exports.createAccessKeyedExpression = createAccessKeyedExpression;
exports.createAccessMemberExpression = createAccessMemberExpression;
exports.createAccessScopeExpression = createAccessScopeExpression;
exports.createAccessThisExpression = createAccessThisExpression;
exports.createArrayBindingPattern = createArrayBindingPattern;
exports.createArrayLiteralExpression = createArrayLiteralExpression;
exports.createArrowFunction = createArrowFunction;
exports.createAssignExpression = createAssignExpression;
exports.createBinaryExpression = createBinaryExpression;
exports.createBindingBehaviorExpression = createBindingBehaviorExpression;
exports.createBindingIdentifier = createBindingIdentifier;
exports.createCallFunctionExpression = createCallFunctionExpression;
exports.createCallGlobalExpression = createCallGlobalExpression;
exports.createCallMemberExpression = createCallMemberExpression;
exports.createCallScopeExpression = createCallScopeExpression;
exports.createConditionalExpression = createConditionalExpression;
exports.createDestructuringAssignmentExpression = createDestructuringAssignmentExpression;
exports.createDestructuringAssignmentRestExpression = createDestructuringAssignmentRestExpression;
exports.createDestructuringAssignmentSingleExpression = createDestructuringAssignmentSingleExpression;
...
exports.createPrimitiveLiteralExpression = createPrimitiveLiteralExpression;
exports.createTaggedTemplateExpression = createTaggedTemplateExpression;
exports.createTemplateExpression = createTemplateExpression;
exports.createUnaryExpression = createUnaryExpression;
exports.createValueConverterExpression = createValueConverterExpression;
