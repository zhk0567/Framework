...
import { createAccessScopeExpression, Unparser, createAccessMemberExpression, ExpressionParser } from '@aurelia/expression-parser';
...
function __typecheck_template_${classes.map(x => x.name).join('_')}__() {
  ...
  return \`${html}\`;
    ...
    createMemberAccessExpression(member) {
        return createAccessMemberExpression(_a.rootAccessScope, member);
    }
    pushScope(type) {
...
TypeCheckingContext.rootAccessScope = createAccessScopeExpression(_a._o, 0);
...
export const template = ${s((_b = (_a = options.transformHtml) === null || _a === void 0 ? void 0 : _a.call(options, html)) !== null && _b !== void 0 ? _b : html)};
