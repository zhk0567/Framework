...
const errorsMap = {
    ...
    [24 /* ErrorNames.factory_not_constructable_resolved */]: `The resolved factory for key '{{0}}' is not constructable.`,
};
...
class Container {
    ...
    getFactory(Type) {
        ...
        if (!isFunction(RealType)) {
            throw createMappedError(9 /* ErrorNames.unable_jit_non_constructor */, RealType);
        }
